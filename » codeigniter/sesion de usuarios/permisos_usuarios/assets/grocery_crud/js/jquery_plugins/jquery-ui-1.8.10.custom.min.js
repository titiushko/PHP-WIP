...
resize:function(b,a){
    ...
    left:c.position.left-f.left||0
        ...
        e(i).each(function(){
            ...
            "height","top","left"];e.each(r,function(n,o){
...
stop:function(){
    ...
    g=parseInt(a.element.css("left"),10)+(a.position.left-a.originalPosition.left)||null;var h=parseInt(a.element.css("top"),10)+(a.position.top-a.originalPosition.top)||null;a.element.animate(e.extend(f,h&&g?{
        top:h,
    left:g
        }:{}),{
...
var d=
e(a),f=[];e(["Top","Right","Left","Bottom"]).each(function(i,j){
...
d=a.containerOffset,f=a.position;b=a._aspectRatio||b.shiftKey;var g={
top:0,
    left:0
