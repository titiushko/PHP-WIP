            ...
            if(k.startContainer==l&&k.endContainer==l){
                ...
                if(l.body.childNodes.length==0){
                    ...
                    if(k.createContextualFragment){
                        ...
                        var m=l.createDocumentFragment(),f=l.createElement("div");
                        m.appendChild(f);
                        f.outerHTML=j;
                        k.insertNode(m)
                        }
    ...
    ForceBlocks:function(o){
        ...
        function n(s,t){
            if(b){
                ...
                t.content=m._replace(p.rePadd,"<"+r+"$1$2$3$4$5$6>\u00a0</"+r+">",t.content);
            if(!c&&!b&&t.set){
                t.content=t.content.replace(p.reNbsp2BR1,"<"+r+"$1$2><br /></"+r+">");
                t.content=t.content.replace(p.reNbsp2BR2,"<"+r+"$1$2><br /></"+r+">")
                }else{
                t.content=m._replace(p.reBR2Nbsp,"<"+r+"$1$2>\u00a0</"+r+">",t.content)
                }
            }
...
function ae(ag){
    ...
    I.walk(ag,function(aj){
        ...
        if((ad.wrap_links!==false||ap!="a")&&d(ai,ap)&&d(ao,ai)){
        if(!ak){
            ak=ah.cloneNode(Q);
