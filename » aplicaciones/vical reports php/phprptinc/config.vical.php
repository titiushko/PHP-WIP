...
define("EWRPT_PROJECT_NAME", "vical", TRUE); // Project Name
define("EWRPT_PROJECT_VAR", "vical", TRUE); // Project Var
...
define("EWRPT_CONN_USER", 'vidrio', TRUE);
define("EWRPT_CONN_PASS", 'ciclopentanoperhidrofenantreno', TRUE);
define("EWRPT_CONN_DB", 'vical', TRUE);
...
define("EWRPT_RANDOM_KEY", 'a%8Ce&W3_x5EzeX1', TRUE); // Random key for encryption
define("EWRPT_PROJECT_STYLESHEET_FILENAME", "phprptcss/vical.css", TRUE); // Project stylesheet file name
...
// User admin
define("EWRPT_LOGIN_SELECT_SQL", "SELECT * FROM `usuarios`", TRUE);

// User table filters
define("EWRPT_USER_NAME_FILTER", "(`USUARIO` = '%u')",  TRUE);
define("EWRPT_USER_ID_FILTER", "",  TRUE);
